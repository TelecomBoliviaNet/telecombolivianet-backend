...
{
    /// <summary>
    /// Asegura que todas las columnas extendidas de SupportTickets existan en la base de datos.
    /// Necesario cuando la BD tiene registradas las migraciones 20250106 y 20250108
    /// en __EFMigrationsHistory pero sus columnas nunca fueron creadas físicamente.
    /// Usa IF NOT EXISTS en cada operación para ser idempotente.
    /// </summary>
    [Migration("20250110000000_EnsureTicketColumnsExist")]
    public partial class EnsureTicketColumnsExist : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // ── Columnas extendidas de SupportTickets ─────────────────────────
            ...
            migrationBuilder.Sql(@"
                CREATE TABLE IF NOT EXISTS ""DashboardPreferences"" (
                    ...
                    ""ShowTendencia""    boolean NOT NULL DEFAULT true,
                    ""ShowTickets""      boolean NOT NULL DEFAULT true,
                    ""ShowWhatsApp""     boolean NOT NULL DEFAULT true,
                    ""ShowDeudores""     boolean NOT NULL DEFAULT true,
                    ""ShowZonas""        boolean NOT NULL DEFAULT true,
                    ""ShowMetodosPago""  boolean NOT NULL DEFAULT true,
                    ""ShowComprobantes"" boolean NOT NULL DEFAULT true,
                    ""UpdatedAt""        timestamp with time zone NOT NULL DEFAULT now(),
                    CONSTRAINT ""PK_DashboardPreferences"" PRIMARY KEY (""Id""),
                    CONSTRAINT ""FK_DashboardPreferences_UserSystems_UserId""
                        FOREIGN KEY (""UserId"") REFERENCES ""UserSystems""(""Id"") ON DELETE CASCADE
                );
                CREATE UNIQUE INDEX IF NOT EXISTS ""IX_DashboardPreferences_UserId"" ON ""DashboardPreferences""(""UserId"");
            ");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"DROP TABLE IF EXISTS ""DashboardPreferences"";");
